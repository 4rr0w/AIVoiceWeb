...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick, content = '' }) => (
  ...
  >
    ...
    { active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.8)] rounded-b-[24px]">
        ...
        <p className="mt-[16px] font-semibold sm:text-[18px] text-[16px] text-white">
          {content}
        </p>
      </div>
    )}
